...
class SpikeInstantDeathOption extends Option
{
	public function new(desc:String)
	{
		super();
	...
	public override function press():Bool
	{
		FlxG.save.data.spikeInstantDeath = !FlxG.save.data.spikeInstantDeath;
		display = updateDisplay();
		return true;
	}
	...
	private override function updateDisplay():String
	{
		return FlxG.save.data.spikeInstantDeath ? "Spike Instant Death: Enabled" : "Spike Instant Death: Disabled";
	}
}
